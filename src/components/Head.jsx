...
{
    return (
        <div className='sticky py-4 top-0 bg-[#e6e0f4] z-50' >
        <div className='flex justify-around '>
            ...
            <div className='flex '>
                ...
                <div  className="ml-8 cursor-pointer  w-28 pl-4 mx-2 bg-[#5a3cee] text-white hover:bg-[#8f78ff] rounded-md py-3">Get Started</div>
            </div>  
        </div>
        </div>
    )
