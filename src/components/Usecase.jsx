...
export default function Sample()
{
    ...
    return (
        <div>
                <div onMouseLeave={(v)=>{setVal(false)}} onMouseEnter={(v)=>{setVal(true)}} className='flex cursor-pointer bg-[#e6e0f4] py-3 w-32 px-4  hover:bg-[#fff] text-black hover:h-12 hover:text-[#7559ff] hover:bg-[#ddd] hover:rounded-full'>
                    Use Cases{!val? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 pt-2">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                ...
                {val && <div  onMouseLeave={(v)=>{setVal(false)}} onMouseEnter={(v)=>{setVal(true)}}  className="absolute bg-white rounded-xl p-2">
                        <div className=" p-4 ">
                            <p className=" hover:text-[#7559ff] p-2 cursor-pointer">Sales Outreach</p>
                            <p className=" hover:text-[#7559ff] p-2 cursor-pointer">Product Marketing</p>
                            <p className=" hover:text-[#7559ff] p-2 cursor-pointer">Content Marketing</p>
                        </div>
                    </div>}
        </div>
    )
